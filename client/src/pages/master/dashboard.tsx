  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <main className="max-w-lg mx-auto px-4 py-4 space-y-6">
        {/* Status banner */}
        {!isOnline && (
          <div className="rounded-2xl bg-muted border border-border px-4 py-3 text-sm text-muted-foreground">
        ...
        <section>
          ...
          {isOnline ? (
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-1">
                    <span className="text-xs text-muted-foreground">
                      {req.responses === 0 ? "Откликов ещё нет" : `${req.responses} отклик(а)`}
                    </span>
                    <button
            ...
            <div className="rounded-2xl bg-muted border border-border py-8 flex flex-col items-center gap-2 text-center">
              <ToggleLeft className="w-10 h-10 text-muted-foreground/50" />
              <p className="text-sm text-muted-foreground">Включите онлайн, чтобы видеть новые заявки</p>
            </div>
          )}
        </section>
        ...
        <section className="rounded-2xl bg-primary/5 border border-primary/20 px-4 py-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Мастера с фото и описанием получают в 3× больше заявок</p>
            </div>
            <button
